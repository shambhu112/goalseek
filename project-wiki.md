# goalseek Project Wiki

## Table of Contents

- [Overview](#overview)
- [Getting Started](#getting-started)
- [Project Structure and Directory Layout](#project-structure-and-directory-layout)
- [Core Architecture](#core-architecture)
  - [The Research Loop and Phase Engine](#the-research-loop-and-phase-engine)
  - [State Management and Persistence](#state-management-and-persistence)
  - [Manifest and Configuration](#manifest-and-configuration)
  - [Context Reading and Direction Service](#context-reading-and-direction-service)
  - [Verification and Metric Extraction](#verification-and-metric-extraction)
- [CLI Reference](#cli-reference)
  - [Project and Manifest Commands](#project-and-manifest-commands)
  - [Lifecycle Commands](#lifecycle-commands)
  - [Observability and Utility Commands](#observability-and-utility-commands)
- [Provider System](#provider-system)
  - [Provider Protocol and Registry](#provider-protocol-and-registry)
  - [Built-in Providers](#built-in-providers)
  - [Prompt Construction](#prompt-construction)
- [Git Operations](#git-operations)
  - [Repo Wrapper](#repo-wrapper)
  - [Rollback and Scope Enforcement](#rollback-and-scope-enforcement)
- [Logging and Observability](#logging-and-observability)
  - [Runtime Logging Configuration](#runtime-logging-configuration)
  - [Research Artifacts and Result Records](#research-artifacts-and-result-records)
- [Test Package (Demo Project)](#test-package-demo-project)
- [Testing](#testing)
  - [Unit Tests](#unit-tests)
  - [Integration Tests and Fixtures](#integration-tests-and-fixtures)
- [Utilities and Error Handling](#utilities-and-error-handling)
...
`goalseek` is a local-first Python package designed for running disciplined, git-backed research loops with coding-agent providers [README.md:3-3](). It provides a structured environment for autonomous agents to propose changes, implement them, and verify results against defined metrics, while maintaining a complete audit trail via git and local artifacts [README.md:108-115]().

The system is CLI-first but exposes its core functionality through a Python API, making it suitable for both interactive research and automated pipelines [README.md:5-5]().

### Core Philosophy

The project centers on the concept of a "Research Loop"—an iterative process where an agent (like Claude or Gemini) is given a goal and a codebase, and then systematically attempts to improve a specific metric [README.md:120-135](). Every change is tracked, every verification is logged, and every regression is automatically rolled back using git [README.md:147-150]().
